"""home_credit_risk_model_stability file for ensuring the package is executable
as `home-credit-risk-model-stability` and `python -m home_credit_risk_model_stability`
"""
import importlib
