...
# google_analytics_propensity documentation build
...
from google_analytics_propensity import __version__ as release

# -- Project information -----------------------------------------------------

project = "google_analytics_propensity"
author = "Kedro"
...
htmlhelp_basename = "google_analytics_propensitydoc"
...
latex_documents = [
    (
        master_doc,
        "google_analytics_propensity.tex",
        "google_analytics_propensity Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "google_analytics_propensity",
        "Project google_analytics_propensity codebase.",
        "Data-Science",
    )
]
